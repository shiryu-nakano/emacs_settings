...
(defvar my/org-roam-directory
  (cond
   ((eq system-type 'darwin) "~/org-roam/")
   ((eq system-type 'windows-nt) "C:/Users/NakanoShiryu/Documents/CABiNET/org-roam")
   (t "~/org-roam/"))
  "Base directory for org-roam per OS.")
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(doom-themes org-roam atom-one-dark-theme org-super-agenda org-bullets ox-hugo py-autopep8 material-theme magit key-chord flycheck evil elpy ein dap-mode blacken better-defaults)))
(custom-set-faces
